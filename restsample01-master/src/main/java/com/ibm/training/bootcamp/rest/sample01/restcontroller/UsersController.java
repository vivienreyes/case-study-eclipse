...
public class UsersController {
	...
	public List<User> getUsers(
		...
		try {
			...
			if (StringUtils.isBlank(model)) {
				...
				users = userService.findByName(model, licenseno, weight, capacity, date);
			}
	...
	public Response addUser(User user) {
		...
		try {
			...
			String result = "User saved : " + user.getModel() + " " + user.getLicenseNo() + " " + user.getWeight() + " " + user.getCapacity() + " " + user.getDate() + " ";
	...
	public Response updateUser(User user) {
		...
		try {
			...
			String result = "User updated : " + user.getModel() + " " + user.getLicenseNo() + " " + user.getWeight() + " " + user.getCapacity() + " " + user.getDate() + " ";
